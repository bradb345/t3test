...
export function applicationApprovedEmail(
  ...
  return {
    subject: `Application Approved - Unit ${unitNumber} at ${propertyName}`,
    html: `
<!DOCTYPE html>
<html>
  <head>
    ...
    <style>
      ...
      .details { background-color: #f0fdf4; border-left: 4px solid #10b981; padding: 20px; margin: 24px 0; border-radius: 4px; }
  ...
  <body>
    <div class="container">
      <div class="header">
        ...
        <p>Great news about your rental application</p>
      </div>
      <div class="content">
        <p class="greeting">Hi ${applicantName},</p>
        <p class="message">
          Congratulations! Your application for <strong>Unit ${unitNumber}</strong> at
        ...
        <p class="message">
          Your landlord will finalize the lease signing. You'll be notified once the lease is active
          and you can make your move-in payment.
        </p>
