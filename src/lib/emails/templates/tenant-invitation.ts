  ...
  <head>
    ...
    <style>
      body {
        ...
        line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f7;
      }
      ...
      .property-details { background-color: #f8f9fa; border-left: 4px solid #667eea; padding: 20px; margin: 24px 0; border-radius: 4px; }
      .property-details h3 { margin: 0 0 10px; color: #1a1a1a; font-size: 16px; }
      .property-details p { margin: 5px 0; color: #555; font-size: 14px; }
      .cta-button { display: inline-block; padding: 16px 32px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff !important; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; text-align: center; margin: 24px 0; }
      .info-box { background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 6px; padding: 16px; margin: 24px 0; }
      .info-box p { margin: 0; color: #856404; font-size: 14px; }
      .steps-section { margin: 32px 0; }
      .steps-section h3 { color: #1a1a1a; font-size: 18px; margin-bottom: 16px; }
      .step { display: flex; align-items: flex-start; margin-bottom: 16px; }
      .step-number { background-color: #667eea; color: #ffffff; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 14px; margin-right: 12px; flex-shrink: 0; }
      .step-content { flex: 1; padding-top: 3px; }
      .step-title { font-weight: 600; color: #1a1a1a; margin-bottom: 4px; font-size: 15px; }
      .step-description { color: #666; font-size: 14px; }
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${onboardingUrl}" class="cta-button">Start Onboarding Process</a>
        </div>
        <div class="info-box">
