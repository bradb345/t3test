...
<html>
  <head>
    ...
    <style>
      ...
      .tenant-details { background-color: #f0fdf4; border-left: 4px solid #10b981; padding: 20px; margin: 24px 0; border-radius: 4px; }
      .tenant-details h3 { margin: 0 0 10px; color: #1a1a1a; font-size: 16px; }
      .tenant-details p { margin: 5px 0; color: #555; font-size: 14px; }
      .badge { display: inline-block; padding: 4px 12px; background-color: #dbeafe; color: #1e40af; font-size: 12px; font-weight: 600; border-radius: 9999px; margin-top: 10px; }
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${dashboardUrl}" class="cta-button">View Tenant Details</a>
        </div>
      </div>
      <div class="footer">
        <p>
